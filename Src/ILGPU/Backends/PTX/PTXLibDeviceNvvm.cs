...
namespace ILGPU.Backends.PTX
{
    ...
    internal static class PTXLibDeviceNvvm
    {
        ...
        private const string __nv_fast_sincosf = @"
            ...
            float %cos) {
            entry:
                %call = call void @__nv_fast_sincosf(float %x,float %sin,float %cos)
                ret void %call
            }";
        ...
        private const string __nv_modf = @"
            ...
            double %y) {
            entry:
                %call = call double @__nv_modf(double %x,double %y)
                ret double %call
            }";
        ...
        private const string __nv_modff = @"
            ...
            float %y) {
            entry:
                %call = call float @__nv_modff(float %x,float %y)
                ret float %call
            }";
        ...
        private const string __nv_sincos = @"
            ...
            double %cos) {
            entry:
                %call = call void @__nv_sincos(double %x,double %sin,double %cos)
                ret void %call
            }";
        ...
        private const string __nv_sincosf = @"
            ...
            float %cos) {
            entry:
                %call = call void @__nv_sincosf(float %x,float %sin,float %cos)
                ret void %call
            }";
        ...
        private const string __nv_sincospi = @"
            ...
            double %cos) {
            entry:
                %call = call void @__nv_sincospi(double %x,double %sin,double %cos)
                ret void %call
            }";
        ...
        private const string __nv_sincospif = @"
            ...
            float %cos) {
            entry:
                %call = call void @__nv_sincospif(float %x,float %sin,float %cos)
                ret void %call
            }";
